        ...
        <div class="col-12">
          ...
          <div class="card-header table-title">
              <div class=" d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('stockproducts.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nuevo Producto Stock</a>
              </div>
  ...
  new Vue({
    ...
    methods: {
        getItems: function(page){
            ...
            var urlItems = 'stockproducts/list?page=' + page + '&searchText=' + this.searchText + '&cantidad=' + this.cantidad_entradas;
