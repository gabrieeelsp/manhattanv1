        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="card card-thumbnail mb-4 shadow-sm mr-2">
                      ...
                      <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                          <div class="d-flex ">
                          {{ Form::open(['route' => ['stockproducts.image.setpositionfor', $stockproduct->id, $img->id], 'method' => 'PUT']) }}
                            <button type="submit" class="btn btn-sm btn-info mr-1"><i class="fas fa-chevron-left"></i></button>
                          {{ Form::close() }}
                          {{ Form::open(['route' => ['stockproducts.image.setpositionback', $stockproduct->id, $img->id], 'method' => 'PUT']) }}
                            <button type="submit" class="btn btn-sm btn-info"><i class="fas fa-chevron-right"></i></button>
                          {{ Form::close() }}
                          </div>
                          
                          {{ Form::open(['route' => ['stockproducts.stockproductImages.destroy', $stockproduct->id, $img->id], 'method' => 'DELETE']) }}
                ...
                {!! Form::open(['route' => ['stockproducts.stockproductImages.store', $stockproduct->id], 'files' => true]) !!}
