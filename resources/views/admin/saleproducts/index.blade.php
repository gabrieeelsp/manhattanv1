        ...
        <div class="col-12">
          ...
          <div class="card-header table-title">
              <div class=" d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('stockproducts.saleproducts.create', $stockproduct->id) }}" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nuevo Producto Venta</a>
              </div>
                  ...
                  <tr v-for="saleproduct in items">
                    ...
                    <td width="10px">
                      <div class="d-flex justify-content-around">
                        <a :href="'/stockproducts/'+id_stockproduct+'/saleproducts/' + saleproduct.id + '/edit'" class="text-warning"><i class="fas fa-edit"></i></a>
...
<script>
  new Vue({
    ...
    data: {
        ...
        id_stockproduct: {{ $stockproduct->id }}
    ...
    methods: {
        getItems: function(page){
            ...
            var urlItems = '/stockproducts/'+ this.id_stockproduct +'/saleproducts/list?page=' + page + '&searchText=' + this.searchText + '&cantidad=' + this.cantidad_entradas;
