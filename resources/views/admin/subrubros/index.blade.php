        ...
        <div class="col-12">
          ...
          <div class="card-header table-title">
              <div class=" d-flex justify-content-between align-items-center">
                <h3 class="card-title" >Gestión <b>Sub-Rubros</b></h3>
                <a href="{{ route('subrubros.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Nueva Sub-Rubro</a>
              </div>
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-striped table-hover border-top">
                ...
                <tbody>
                  <tr v-for="subrubro in items">
                    <td>@{{ subrubro.id }}</td>
                    <td>@{{ subrubro.name }}</td>
                    <td width="10px"> 
                      <span v-show="subrubro.web_enable" class="badge bg-success">enable</span>
                      <span v-show="!subrubro.web_enable" class="badge bg-red">disable</span>
                    </td>
                    <td width="10px">
                      <div class="d-flex justify-content-around">
                        <a :href="'/admin/subrubros/' + subrubro.id + '/edit'" class="text-warning"><i class="fas fa-edit"></i></a>
  ...
  new Vue({
    ...
    methods: {
        getItems: function(page){
            ...
            var urlItems = 'subrubros/list?page=' + page + '&searchText=' + this.searchText + '&cantidad=' + this.cantidad_entradas;
